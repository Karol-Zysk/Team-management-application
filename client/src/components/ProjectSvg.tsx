...
const ProjectSvg = () => {
  return (
    <Flex direction="column" display={["none", "flex"]} align="center">
      ...
      >
        <path
          id="a9fff5a8-4449-4722-8691-2681997674a8-203"
        ...
        />
        <path
          id="ef08fdaa-4829-440e-93ff-da8e736c3be7-204"
          data-name="fc60a940-5b5f-47e1-886f-8b9349204f05"
          d="M284.18544,222.953h308.942v-84.8h-308.942Z"
          transform="translate(-236.05344 -131.32002)"
          fill="#fff"
        />
        <path
          id="f7452840-914d-46a1-ae61-ea1c2fc2d2a5-205"
        ...
        />
        <path
          id="a3321d5c-167e-43b0-8c0e-18df1c8c5ae5-206"
        ...
        />
        <path
          id="f7b9bcea-10c4-4c80-b4a6-3d8e323f573e-207"
        ...
        />
        <path
          id="f7c5b60e-33a7-4042-9d2c-5c8c9116b84c-208"
        ...
        />
        <path
          id="a8273e4e-93d2-47bb-9b17-df51a96534af-209"
          data-name="f05ecdaf-6a8f-49c4-b8a7-f7e5ce9efcf7"
          d="M408.96144,371.916h308.943v-84.8h-308.943Z"
          transform="translate(-236.05344 -131.32002)"
          fill="#fff"
        />
        <path
          id="a87d1795-16f3-4774-9768-c375c1bdbb9e-210"
        ...
        />
        <path
          id="fcead4ff-5625-4c61-90c0-6a9c2def1900-211"
        ...
        />
        <path
          id="b25442e4-8332-4a87-9c30-01930e0b437c-212"
        ...
        />
        <path
          id="f3e6157c-e0fb-4525-9ebd-9efe95b1618f-213"
        ...
        />
        <path
          id="b96defd0-9a2c-4c45-aa8c-b5fd1840c319-214"
          data-name="acd48b1a-d10a-4276-b388-f016adebff0c"
          d="M242.88744,520.88h308.943v-84.8h-308.943Z"
          transform="translate(-236.05344 -131.32002)"
          fill="#fff"
        />
        <path
          id="a2204f79-048d-45a5-9dbf-3ca685e385ac-215"
        ...
        />
        <path
          id="b2ebcab4-d8cf-428d-87b9-c73daac40ac9-216"
        ...
        />
        <path
          id="aca123b7-0fc2-4f3d-89c1-779a89955e8d-217"
        ...
        <circle
          ...
          cy="346.13193"
          r="28.36217"
          transform="translate(-295.44324 328.48424) rotate(-28.66322)"
          fill="#ffb7b7"
        />
        <path
          d="M940.867,768.68h-230a1,1,0,0,1,0-2h230a1,1,0,0,1,0,2Z"
          transform="translate(-236.05344 -131.32002)"
          fill="#cbcbcb"
        />
        <path
